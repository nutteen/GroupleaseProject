...
<html>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="container">
      	...
      	<h2>Hi there!</h2>
        <div>			This website is developed by Peeranut Ngaorungsri (Nut).
        	<br/> The purpose of this website is to show how to create a web-application using Spring MVC and,
        	Twitter Bootstrap. It utilises MySQL 5 for the database.
       		<br/> Created date: 6/11/2015
       	</div>
      </header>
